...
class InstgramApp extends StatefulWidget {
  const InstgramApp({super.key});

  @override
  State<InstgramApp> createState() => _InstgramAppState();
}

class _InstgramAppState extends State<InstgramApp> {
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Colors.red,
                                border:
                                    Border.all(color: Colors.red, width: 3.5),
                              ),
                              child: ClipRRect(
